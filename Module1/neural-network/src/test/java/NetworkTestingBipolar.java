...
public class NetworkTestingBipolar {
    ...
    public void test_network() {
        doTraining();
        EntryTarget test1 = new EntryTarget(new double[]{-1, -1}, new double[]{-1});
        EntryTarget test2 = new EntryTarget(new double[]{-1, 1}, new double[]{1});
        EntryTarget test3 = new EntryTarget(new double[]{1, 1}, new double[]{-1});
        EntryTarget test4 = new EntryTarget(new double[]{1, -1}, new double[]{1});

        EntryTarget[] testers = new EntryTarget[]{test1, test2, test3, test4};
    ...
    private void doTraining() {
        ...
        EntryTarget train1 = new EntryTarget(new double[]{-1, -1}, new double[]{-1});
        EntryTarget train2 = new EntryTarget(new double[]{-1, 1}, new double[]{1});
        EntryTarget train3 = new EntryTarget(new double[]{1, 1}, new double[]{-1});
        EntryTarget train4 = new EntryTarget(new double[]{1, -1}, new double[]{1});
        ...
        while (one || two || three || four) {
            ...
            net.setEntriesAndTargets(train4.entries, train4.targets);
            four = net.trainNetwork();
        }
