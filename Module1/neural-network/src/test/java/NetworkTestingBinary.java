...
public class NetworkTestingBinary {
    ...
    public void test_network() {
        doTraining();
        EntryTarget test1 = new EntryTarget(new double[]{0, 0}, new double[]{0});
        EntryTarget test2 = new EntryTarget(new double[]{0, 1}, new double[]{1});
        EntryTarget test3 = new EntryTarget(new double[]{1, 1}, new double[]{0});
        EntryTarget test4 = new EntryTarget(new double[]{1, 0}, new double[]{1});
    ...
    private void doTraining() {
        ...
        EntryTarget train1 = new EntryTarget(new double[]{0, 0}, new double[]{0});
        EntryTarget train2 = new EntryTarget(new double[]{0, 1}, new double[]{1});
        EntryTarget train3 = new EntryTarget(new double[]{1, 1}, new double[]{0});
        EntryTarget train4 = new EntryTarget(new double[]{1, 0}, new double[]{1});
